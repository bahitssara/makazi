...
import './OurStoryFullPg.css';


export default function OurStoryFullPg(){
    return(
        <section className='our-story-full'>
            <div className='our-story-text-full'>
